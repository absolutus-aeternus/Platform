...
.form-group input:focus, .form-group select:focus { outline: none; border-color: #fe2c55; }
.hint { font-size: 12px; color: #999; margin-top: 4px; }
.btn-save { padding: 12px 24px; background: #fe2c55; color: #fff; border: none; border-radius: 8px; cursor: pointer; font-weight: 600; }
...
.zone-rate { font-weight: 600; color: #fe2c55; }
...
.btn-add-zone:hover { border-color: #fe2c55; color: #fe2c55; }
