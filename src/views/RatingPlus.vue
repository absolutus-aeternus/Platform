...
const programs = [
  { icon: 'fas fa-star', title: 'Rating Produk', amount: '$5 - $50', desc: 'Beri rating dan review produk di marketplace.', bg: 'rgba(255,77,0,0.15)', color: '#ff4d00' },
  ...
  { icon: 'fas fa-share-alt', title: 'Social Media', amount: '$3 - $30', desc: 'Share konten dan dapatkan komisi per interaksi.', bg: 'rgba(124,92,255,0.15)', color: '#7c5cff' },
]
...
.accent { color: #ff4d00; } .dim { color: rgba(240,236,230,.5); } .green { color: #00e68a; }
...
.hero-badge { display: inline-flex; align-items: center; gap: 8px; padding: 6px 16px; border-radius: 100px; background: rgba(255,77,0,0.1); border: 1px solid rgba(255,77,0,0.2); font-size: 0.72rem; font-weight: 700; color: #ff4d00; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 20px; }
.hero-badge .dot { width: 6px; height: 6px; border-radius: 50%; background: #ff4d00; animation: blink 2s infinite; }
...
.hero-cta.pulse-btn { background: linear-gradient(135deg, #ff4d00, #ff6b3d); color: #fff; box-shadow: 0 4px 16px rgba(255,77,0,0.25); }
...
.big-r { font-size: 6rem; font-weight: 900; background: linear-gradient(135deg, #ff4d00, #7c5cff); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
...
.about-feat .ico { width: 32px; height: 32px; border-radius: 8px; display: flex; align-items: center; justify-content: center; color: #ff4d00; background: rgba(255,77,0,0.1); }
...
.step-num { position: absolute; top: -8px; left: -8px; width: 28px; height: 28px; background: #ff4d00; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 800; font-size: 0.75rem; }
...
.auth-brand { width: 56px; height: 56px; border-radius: 16px; margin: 0 auto 16px; background: linear-gradient(135deg, #ff4d00, #7c5cff); display: flex; align-items: center; justify-content: center; font-size: 1.4rem; font-weight: 900; color: #fff; box-shadow: 0 8px 24px rgba(255,77,0,0.25); }
...
.btn-submit { width: 100%; padding: 13px; border-radius: 12px; border: none; background: linear-gradient(135deg, #ff4d00, #ff6b3d); color: #fff; font-weight: 700; font-size: 0.875rem; cursor: pointer; font-family: inherit; transition: all 0.3s; box-shadow: 0 4px 16px rgba(255,77,0,0.25); margin-top: 4px; }
