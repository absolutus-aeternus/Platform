...
.form-check input { margin-top: 3px; accent-color: var(--primary, #ee4d2d); }
.form-check a { color: var(--primary, #ee4d2d); font-weight: 600; }
...
.btn-social:hover { border-color: var(--primary, #ee4d2d); color: var(--primary, #ee4d2d); }
...
.seller-link:hover { color: var(--primary, #ee4d2d) !important; }
