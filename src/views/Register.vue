...
.form-check input { margin-top: 3px; accent-color: var(--primary, #FF9900); }
.form-check a { color: var(--primary, #FF9900); font-weight: 600; }
...
.alert-success { color: #28a745; text-align: center; margin-top: 14px; font-size: 13px; padding: 10px; background: #f0fff4; border-radius: 8px; display: flex; align-items: center; justify-content: center; gap: 6px; }
...
.btn-social:hover { border-color: var(--primary, #FF9900); color: var(--primary, #FF9900); }
...
.seller-link:hover { color: var(--primary, #FF9900) !important; }
