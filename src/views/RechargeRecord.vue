...
<div v-else class="container" style="padding:40px 20px">
    <h2 style="margin-bottom:24px"><i class="fas fa-history"></i> Recharge History</h2>
    <div v-if="records.length" style="background:white;border-radius:16px;overflow:hidden;border:1px solid #e2e8f0">
      <table class="data-table">
        <thead><tr><th>ID</th><th>Amount</th><th>Coin</th><th>Chain</th><th>Status</th><th>Date</th></tr></thead>
        <tbody>
    ...
    <div v-else class="empty-state"><i class="fas fa-history"></i><p>No recharge records yet. Your transaction history will appear here.</p></div>
  </div>
</template>
