...
const posts = [
  { id: 1, title: 'How to Find the Best Deals on AllianceHub', excerpt: 'Discover insider tips for finding the lowest prices, using flash sales, and stacking coupons for maximum savings.', tag: 'Shopping Tips', date: 'Aug 10, 2026', views: '2.3K', icon: 'fas fa-tags', gradient: 'linear-gradient(135deg, #FF9900, #e68a00)' },
  { id: 2, title: 'Complete Guide to Starting Your Online Store', excerpt: 'Everything you need to know about becoming a seller on AllianceHub, from registration to your first sale.', tag: 'Seller Guide', date: 'Aug 8, 2026', views: '1.8K', icon: 'fas fa-store', gradient: 'linear-gradient(135deg, #007185, #00a0c4)' },
