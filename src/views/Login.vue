  ...
  <div class="login-page">
    ...
    <div class="login-card animate-in">
      ...
      <div class="login-footer">
        ...
        <p><router-link to="/ratingplus" class="seller-link" style="color: #e68a00 !important"><i class="fas fa-star"></i> Join Rating Plus — Earn Money</router-link></p>
      </div>
    </div>
  </div>
</template>
...
.logo-icon { width: 40px; height: 40px; background: var(--primary, #FF9900); color: #fff; border-radius: 10px; display: flex; align-items: center; justify-content: center; font-weight: 800; font-size: 16px; }
...
.login-tabs button.active { background: #fff; color: var(--primary, #FF9900); box-shadow: 0 2px 8px rgba(0,0,0,0.08); }
...
.input-icon input:focus { outline: none; border-color: var(--primary, #FF9900); box-shadow: 0 0 0 3px rgba(238,77,45,0.08); background: #fff; }
...
.remember input { accent-color: var(--primary, #FF9900); }
.forgot { color: var(--primary, #FF9900); text-decoration: none; font-weight: 500; }
.btn-login { width: 100%; padding: 14px; background: var(--primary, #FF9900); color: #fff; border: none; border-radius: 10px; font-size: 15px; font-weight: 600; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 8px; transition: all 0.3s; }
.btn-login:hover { background: var(--primary-dark, #e68a00); transform: translateY(-2px); box-shadow: 0 8px 25px rgba(238,77,45,0.4); }
...
.btn-social:hover { border-color: var(--primary, #FF9900); color: var(--primary, #FF9900); background: #fff8f0; }
...
.login-footer a { color: var(--primary, #FF9900); font-weight: 600; text-decoration: none; }
