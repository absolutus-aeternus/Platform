...
.login-tabs button.active { background: #fff; color: var(--brand-primary, #FF9900); box-shadow: 0 2px 8px rgba(0,0,0,0.08); }
...
.remember input { accent-color: var(--brand-primary, #FF9900); }
.forgot { color: var(--brand-primary, #FF9900); text-decoration: none; font-weight: 500; }
...
.btn-social:hover { border-color: var(--brand-primary, #FF9900); color: var(--brand-primary, #FF9900); background: #fff8f0; }
