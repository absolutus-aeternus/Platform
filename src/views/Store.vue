          ...
          <div class="store-profile">
            ...
            <div class="store-info">
              ...
              <p class="store-stats">
                ...
                <span><i class="fas fa-star" style="color:var(--brand-primary, var(--brand-primary, #FF9900))"></i> {{ store.rating || '4.8' }} Rating</span>
...
const getGradient = (name) => {
  const colors = ['var(--brand-nav, #232F3E))','#37475a','var(--brand-dark, var(--brand-dark, #131921))','var(--brand-accent, var(--brand-accent, #007185))','#4a4e69','#3a5a40']
...
.store-avatar span { font-size: 32px; font-weight: 700; color: var(--brand-primary, var(--brand-primary, #FF9900)); }
.store-info { flex: 1; }
...
.btn-follow:hover { border-color: var(--brand-accent, var(--brand-accent, #007185)); color: var(--brand-accent, var(--brand-accent, #007185)); }
.btn-follow.following { background: var(--brand-accent, var(--brand-accent, #007185)); color: #fff; border-color: var(--brand-accent, var(--brand-accent, #007185)); }
...
.store-tabs button.active { color: var(--brand-accent, var(--brand-accent, #007185)); border-bottom-color: var(--brand-primary, var(--brand-primary, #FF9900)); font-weight: 600; }
...
.product-card:hover { border-color: var(--brand-primary, var(--brand-primary, #FF9900)); box-shadow: 0 2px 8px rgba(255,153,0,0.15); transform: translateY(-2px); }
...
.product-name { font-size: 0.8125rem; color: var(--brand-accent, var(--brand-accent, #007185)); display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; line-height: 1.4; min-height: 2.25rem; margin-bottom: 4px; }
.product-card:hover .product-name { color: #c77a00; }
.rating-row { display: flex; align-items: center; gap: 4px; margin-bottom: 4px; }
.stars { font-size: 0.625rem; color: var(--brand-primary, var(--brand-primary, #FF9900)); }
.review-count { font-size: 0.6875rem; color: var(--brand-accent, var(--brand-accent, #007185)); }
