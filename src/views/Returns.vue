<template>
  <div class="container" style="padding:40px 20px;max-width:800px">
    <h1 style="margin-bottom:30px"><i class="fas fa-undo" style="color:#FF9900"></i> Return Policy</h1>
    <div style="background:#fff;padding:32px;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,0.08);line-height:1.8">
      ...
      <p>If you have questions about a return, contact us through <router-link to="/customer-service" style="color:#FF9900">Customer Service</router-link> or live chat.</p>
    </div>
  </div>
</template>
