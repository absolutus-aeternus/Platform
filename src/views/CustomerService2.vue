<template>
  <div class="container" style="padding:40px 20px;max-width:800px">
    <h2 style="margin-bottom:24px"><i class="fas fa-headset" style="color:#fe2c55"></i> Customer Service</h2>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px">
      <div style="background:#fff;padding:24px;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,0.08);text-align:center">
        ...
        <h3>Live Chat</h3>
        <p style="color:#666;font-size:14px;margin-bottom:12px">Chat with our support team</p>
    ...
    <div style="margin-top:24px;text-align:center">
      <router-link to="/help" style="color:#fe2c55;margin-right:20px">Help Center</router-link>
