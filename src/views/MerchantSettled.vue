...
.step.done:not(:last-child)::after { background: #28a745; }
.step-num {
...
.btn-submit-green { background: linear-gradient(135deg, #28a745, #20c997); box-shadow: 0 4px 15px rgba(40,167,69,0.3); }
...
.success-step h2 { color: #28a745; margin-bottom: 8px; }
