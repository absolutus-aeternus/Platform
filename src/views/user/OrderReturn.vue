...
.form-group input:focus, .form-group select:focus, .form-group textarea:focus { outline: none; border-color: #fe2c55; }
...
.return-option.active { border-color: #fe2c55; background: #fff5f5; }
...
.return-info li::before { content: '•'; position: absolute; left: 0; color: #fe2c55; font-weight: bold; }
</style>
