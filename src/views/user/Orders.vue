...
.order-tabs button.active { background: var(--brand-primary, var(--brand-primary, #FF9900)); color: #fff; border-color: var(--brand-primary, var(--brand-primary, #FF9900)); }
.loading { text-align: center; padding: 40px; color: #999; }
.empty-state { text-align: center; padding: 60px 0; }
.empty-state i { font-size: 48px; color: #ddd; margin-bottom: 15px; display: block; }
.btn-primary { background: var(--brand-primary, var(--brand-primary, #FF9900)); color: #fff; padding: 10px 25px; border-radius: 25px; text-decoration: none; display: inline-block; margin-top: 15px; }
...
.order-total { font-weight: 700; color: var(--brand-primary, var(--brand-primary, #FF9900)); }
