...
.notification-card.unread { border-left: 3px solid var(--brand-primary, #FF9900); }
.notif-icon { width: 40px; height: 40px; background: #f0f0f0; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: var(--brand-primary, #FF9900); }
