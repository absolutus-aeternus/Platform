...
.balance-card { background: linear-gradient(135deg, #FF9900 0%, #ff6b81 100%); color: #fff; padding: 30px; border-radius: 12px; margin-bottom: 20px; }
...
.btn-recharge { background: #fff; color: #FF9900; border: none; }
