...
.dl-icon { width: 48px; height: 48px; background: #f0f0f0; border-radius: 10px; display: flex; align-items: center; justify-content: center; font-size: 20px; color: #fe2c55; }
.dl-info { flex: 1; }
.dl-info h3 { margin: 0 0 4px; font-size: 14px; }
.dl-info p { margin: 0; font-size: 12px; color: #999; }
.btn-download { padding: 8px 16px; background: #fe2c55; color: #fff; border: none; border-radius: 6px; cursor: pointer; font-size: 13px; }
</style>
