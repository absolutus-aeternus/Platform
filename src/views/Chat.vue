...
.unread-badge { background: var(--brand-primary, var(--brand-primary, #FF9900)); color: #fff; font-size: 12px; padding: 2px 8px; border-radius: 10px; }
...
.conversation-item.active { background: #fff8f0; border-left: 3px solid var(--brand-primary, var(--brand-primary, #FF9900)); }
.conversation-item.unread { background: #fff8f8; }
.conv-avatar { width: 45px; height: 45px; background: var(--brand-primary, var(--brand-primary, #FF9900)); color: #fff; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700; flex-shrink: 0; }
...
.unread-dot { width: 10px; height: 10px; background: var(--brand-primary, var(--brand-primary, #FF9900)); border-radius: 50%; position: absolute; right: 15px; top: 50%; transform: translateY(-50%); }
...
.header-avatar { width: 40px; height: 40px; background: var(--brand-primary, var(--brand-primary, #FF9900)); color: #fff; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700; }
...
.message.own .message-bubble { background: var(--brand-primary, var(--brand-primary, #FF9900)); color: #fff; }
...
.chat-input textarea:focus { outline: none; border-color: var(--brand-primary, var(--brand-primary, #FF9900)); }
.chat-input button { width: 40px; height: 40px; background: var(--brand-primary, var(--brand-primary, #FF9900)); color: #fff; border: none; border-radius: 50%; cursor: pointer; display: flex; align-items: center; justify-content: center; }
