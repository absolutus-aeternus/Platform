...
.product-card { background: var(--bg-card, #fff); border-radius: 8px; overflow: hidden; cursor: pointer; position: relative; box-shadow: 0 2px 8px rgba(0,0,0,0.08); }
...
.img-placeholder { height: 200px; background: var(--neutral-100, #f0f0f0); display: flex; align-items: center; justify-content: center; font-size: 48px; color: #ccc; }
...
.original { color: var(--text-muted, #999); text-decoration: line-through; font-size: 13px; margin-left: 8px; }
.product-sales { color: var(--text-muted, #999); font-size: 12px; }
