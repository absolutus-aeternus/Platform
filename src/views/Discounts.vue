...
.discount-badge { position: absolute; top: 10px; left: 10px; background: #FF9900; color: #fff; padding: 4px 10px; border-radius: 4px; font-size: 12px; font-weight: 700; z-index: 1; }
