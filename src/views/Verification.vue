...
.logo { font-size: 36px; font-weight: 800; color: #FF9900; margin-bottom: 30px; }
...
.btn-enter { background: #FF9900; color: #fff; border: none; padding: 15px 40px; font-size: 18px; border-radius: 25px; cursor: pointer; transition: all 0.3s; }
