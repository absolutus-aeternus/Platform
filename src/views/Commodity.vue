...
.cat-filter button.active { background: var(--primary, #ee4d2d); color: #fff; border-color: var(--primary, #ee4d2d); }
.cat-filter button:hover:not(.active) { border-color: var(--primary, #ee4d2d); color: var(--primary, #ee4d2d); }
