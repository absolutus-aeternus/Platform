...
.filters { background: var(--bg-card, #fff); padding: 12px 16px; border-radius: 4px; box-shadow: 0 1px 2px rgba(0,0,0,0.06); margin-bottom: 16px; }
...
.cat-filter button { padding: 6px 14px; border: 1px solid var(--border, #ddd); background: var(--bg-card, #fff); border-radius: 4px; font-size: 13px; cursor: pointer; transition: all 0.2s; white-space: nowrap; }
...
.sort-filter select { padding: 6px 12px; border: 1px solid var(--border, #ddd); border-radius: 4px; font-size: 13px; cursor: pointer; }
.product-grid { display: grid; grid-template-columns: repeat(5, 1fr); gap: 8px; }
.skeleton-card { background: var(--neutral-100, #f0f0f0); border-radius: 4px; aspect-ratio: 0.8; animation: pulse 1.5s infinite; }
@keyframes pulse { 0%, 100% { opacity: 1; } 50% { opacity: 0.5; } }
.product-card { background: var(--bg-card, #fff); border-radius: 2px; overflow: hidden; cursor: pointer; transition: all 0.2s; border: 1px solid transparent; }
...
.card-img { position: relative; aspect-ratio: 1; overflow: hidden; background: var(--neutral-100, #f8f8f8); }
.card-img img { width: 100%; height: 100%; object-fit: cover; transition: transform 0.3s; }
.product-card:hover .card-img img { transform: scale(1.05); }
.img-placeholder { width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; font-size: 36px; color: #ddd; background: linear-gradient(135deg, var(--neutral-100, #f8f8f8), var(--border-light, #eee)); }
...
.card-title { font-size: 13px; color: var(--text-primary, #333); display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; line-height: 1.4; min-height: 36px; margin-bottom: 6px; }
.card-price { font-size: 16px; font-weight: 700; color: var(--brand-primary, #FF9900); margin-bottom: 4px; }
.card-price .original { font-size: 12px; color: var(--text-muted, #999); text-decoration: line-through; font-weight: 400; margin-left: 4px; }
.card-meta { display: flex; justify-content: space-between; font-size: 11px; color: var(--text-muted, #999); }
.card-meta .rating { color: var(--warning, #B45309); }
.empty-state { text-align: center; padding: 80px 0; color: var(--text-muted, #999); }
