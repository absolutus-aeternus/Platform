...
.cat-filter button.active { background: var(--primary, var(--brand-primary, var(--brand-primary, #FF9900))); color: #fff; border-color: var(--primary, var(--brand-primary, var(--brand-primary, #FF9900))); }
.cat-filter button:hover:not(.active) { border-color: var(--primary, var(--brand-primary, var(--brand-primary, #FF9900))); color: var(--primary, var(--brand-primary, var(--brand-primary, #FF9900))); }
...
.product-card:hover { border-color: var(--primary, var(--brand-primary, var(--brand-primary, #FF9900))); box-shadow: 0 2px 8px rgba(238,77,45,0.12); transform: translateY(-1px); }
...
.badge-discount { position: absolute; top: 0; left: 0; background: var(--primary, var(--brand-primary, var(--brand-primary, #FF9900))); color: #fff; padding: 2px 4px; font-size: 11px; font-weight: 700; }
...
.card-price { font-size: 16px; font-weight: 700; color: var(--primary, var(--brand-primary, var(--brand-primary, #FF9900))); margin-bottom: 4px; }
