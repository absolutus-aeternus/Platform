...
.filter-input:focus { outline: none; border-color: #fe2c55; }
.filter-select { padding: 10px 14px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px; background: #fff; }
.btn-refresh { padding: 10px 16px; background: #fe2c55; color: #fff; border: none; border-radius: 8px; cursor: pointer; font-size: 14px; }
