...
.btn-save { padding: 12px 24px; background: #FF9900; color: #fff; border: none; border-radius: 6px; cursor: pointer; font-size: 14px; font-weight: 600; }
...
.settings-section h2 i { color: #FF9900; }
...
.toggle-label input[type="checkbox"] { width: 18px; height: 18px; accent-color: #FF9900; }
