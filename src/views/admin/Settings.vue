...
.btn-save { padding: 12px 24px; background: #fe2c55; color: #fff; border: none; border-radius: 6px; cursor: pointer; font-size: 14px; font-weight: 600; }
...
.settings-section h2 i { color: #fe2c55; }
...
.toggle-label input[type="checkbox"] { width: 18px; height: 18px; accent-color: #fe2c55; }
