...
.btn-primary { padding: 8px 16px; background: #fe2c55; color: #fff; border: none; border-radius: 6px; cursor: pointer; font-weight: 600; }
...
.role-badge.admin { background: #fe2c55; color: #fff; }
