...
.page-header h1 i { color: #fe2c55; margin-right: 8px; }
...
.input-group:focus-within { border-color: #fe2c55; }
...
.btn-scrape { padding: 16px 32px; background: linear-gradient(135deg, #fe2c55, #ff6b81); color: #fff; border: none; font-size: 15px; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 8px; transition: all 0.2s; }
...
.loader-spinner { width: 48px; height: 48px; border: 4px solid #e2e8f0; border-top-color: #fe2c55; border-radius: 50%; animation: spin 0.8s linear infinite; margin: 0 auto 16px; }
...
.btn-save { padding: 10px 20px; background: linear-gradient(135deg, #28a745, #20c997); color: #fff; border: none; border-radius: 8px; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 6px; }
...
.image-thumbs img.active { border-color: #fe2c55; }
...
.detail-input:focus { outline: none; border-color: #fe2c55; }
...
.source-link { margin-left: 8px; color: #fe2c55; font-size: 13px; }
