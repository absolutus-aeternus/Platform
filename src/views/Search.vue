...
@media (max-width: 1024px) { .product-grid, .loading-state { grid-template-columns: repeat(4, 1fr); } }
@media (max-width: 768px) {
  .product-grid, .loading-state { grid-template-columns: repeat(3, 1fr); }
  .search-filters { flex-direction: column; gap: 10px; align-items: flex-start; }
