  ...
  <div class="user-layout">
    <header class="user-header">
      <div class="container header-inner">
        ...
        <router-link to="/" class="logo"><img loading="lazy" src="/images/logo-horizontal.svg" alt="AllianceHub" class="logo-img-nav" /></router-link>
...
.header-nav a:hover, .header-nav a.router-link-active { color: var(--brand-primary, #FF9900); }
...
.user-avatar { width: 36px; height: 36px; background: var(--brand-dark, #131921); color: #fff; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 14px; }
